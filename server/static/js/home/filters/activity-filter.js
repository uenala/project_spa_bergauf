        ...
        return function (galleries, theme) {
            ...
            angular.forEach(galleries, function (gallery) {
                ...
                if (theme === '/skitouren') {
                    ...
                    if (gallery.activity.indexOf('Bergtour') >= 0 || gallery.activity.indexOf('Hochtour') >= 0 || gallery.activity.indexOf('Klettertour') >= 0 || gallery.activity.indexOf('Bike & Hike') >= 0 || gallery.activity.indexOf('Alpinwanderung') >= 0 || gallery.activity.indexOf('Wanderung') >= 0) {
                        temp.push(gallery);
                    }
                }
...
//# sourceMappingURL=../../home/filters/activity-filter.js.map